<template>
  <div id="platform">
    ...
    <div class="form-bottom form-bottom-fixed">
      <!--<table class="table table-base" id="orgList">-->
      <!--<thead>-->
      <!--<tr>-->
      <!--<th>用户名</th>-->
      <!--<th>操作</th>-->
      ...
      <!--</thead>-->
      <!--<tbody>-->
      <!--<tr v-for="list in lists" class="resultPlatform">-->
      <!--<td><p class="shorten">{{list.name}}</p></td>-->
      <!--<td class="operatePer">-->
      <!--<span class="result-findBtn" @click="updateOrg(list)">修改</span>-->
      <!--<span class="result-findBtn" @click="delate(list)">删除</span>-->
      <!--</td>-->
      <!--</tr>-->
      <!--</tbody>-->
      <!--</table>-->
      <el-table :data="userList" stripe border style="width: 100%">
        ...
        <el-table-column prop="delete" label="操作">
          <template scope="scope">
            <el-button
              size="small"
              type="primary" @click="update(scope.row.id)">修改密码
            </el-button>
            <el-button
              size="small"
